...
test.describe('Instagram Registration Form', () => {
  // Skip in CI with explanation
  test.skip(
    !!process.env.CI, 
    'Instagram actively blocks automated browsers in CI. See Track B (mock-social-app) for full test coverage demonstration.'
  );
